      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <p className="text-[10px] uppercase tracking-[0.25em] text-butter-yellow mt-6 mb-3">
              Follow
            </p>
            <div className="flex items-center gap-4">
              <a
                href="https://www.facebook.com/FarleyCreative"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Farley Creative on Facebook"
                className="text-cream/60 hover:text-butter-yellow transition"
              >
              ...
              <a
                href="https://www.instagram.com/farleygirlscreative/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Farley Creative on Instagram"
                className="text-cream/60 hover:text-butter-yellow transition"
              >
