...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    title: "Sage Em",
    kind: "Brand + Systems",
    client: "Sage Em (Texas lighting manufacturer)",
    year: "2025–present",
    scope: [
      "Brand identity",
      "Sales infrastructure",
      "Outreach pattern library",
      "Spec sheet + brand pack generators",
    ],
    hook_short:
      "Texas lighting manufacturer — brand identity and operating system that turns every artifact (intro email, brand pack, scope sheet, contract) into a structured sales motion.",
    challenge:
      "A Texas-based emergency lighting manufacturer with 29 products across 5 categories needed to land its line card with specifier and rep-agency networks across the country. The principal had decades of manufacturer-rep relationships, deep specifier credibility, and the technical product depth — but the company itself needed a polished commercial presence that could carry that credibility into rooms before he walked in, plus an internal operating system that turned every rep-agency interaction into structured pipeline rather than one-off conversations.",
    hook:
      "Operational simplicity over coverage. A manufacturer's brand is judged by the quality of its first email to a rep agency, the spec sheet it sends a specifier, and the contract it puts in front of a partner — not the number of pages on its website. The work was less about big marketing presence and more about making every routine artifact polished, consistent, and obviously the work of a real firm — at the speed of sales, not the speed of agencies.",
    strategy: [
      "Brand identity calibrated to specifier + rep-agency audience — refined-but-grounded, not generic-corporate",
      "Standard intro-email template productized and validated in live outreach to rep agencies across the country",
      "Quote-based contract structure — operational simplicity over clause coverage; Reserve over Remove for optional terms",
      "Brand pack + ETL form + spec sheet generators rendering from a single canonical source so every external artifact stays verifiably consistent across the line card",
      "Rep-agency roster curation rule (≤15 staff = full roster in agencies database; >15 = leadership-tier cut + full roster in HQ seed) so the system scales as the network grows",
    ],
    outcome: [
      "Foundation v1 signed off in-person by principal (29 products · 5 categories locked)",
      "Multiple rep-agency relationships activated under the contract framework",
      "Standard intro-email pattern landing cleanly in rep-agency outreach (recovery-as-intro composition validated in live exchanges)",
      "Operator-grade dashboard pattern carried forward into other Heye Lab tenant builds",
    ],
    cta:
      "Running a founder-led manufacturer or B2B firm that needs to land its line card with the polish of a much larger company? Let's talk.",
    status: "live",
